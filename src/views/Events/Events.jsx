...
function Events() {
    ...
    return (
        <Container>
            ...
            <Button className="my-3" variant="primary" onClick={handleNewEvent}>Créer un nouvel événement</Button>
            <EventTable events={events} handleUpdate={handleUpdate} handleDelete={handleDelete}/>

            {showModal
                &&
                <FormModal title="Ajouter un événement" show={showModal}
